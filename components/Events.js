...
const eventsData = [
  {
    ...
    description: "Kano, Nigeria • 8/8/2024 • 4:00:00 PM • No description available • invitation"
  },
  {
    id: 2,
    ...
    description: "Lagos, Nigeria • 15/9/2024 • 6:00:00 PM • No description available • invitation"
  },
  {
    id: 3,
    ...
    description: "Abuja, Nigeria • 22/10/2024 • 7:00:00 PM • No description available • invitation"
  }
];
...
const Events = () => {
  ...
  return (
    <div
      ...
      id="events"
    >
      <div className="orido_tm_portfolio w-full h-auto clear-both float-left bg-white px-0 pt-[120px] pb-[110px]">
                ...
                <SwiperSlide key={item.id}>
                  <div className="list_inner">
                    ...
                    <div className="details w-full float-left mt-[30px]">
                      <span className="category text-[20px] inline-block mb-[13px] text-blue-600 font-bold">
                        {item.category}
                      </span>
